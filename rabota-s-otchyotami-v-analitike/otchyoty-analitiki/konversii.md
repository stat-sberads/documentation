...
Статистика от SberAds на основе истории переходов посетителя поддерживает следующие модели атрибуции:
...
Для начала необходимо завести целевое событие (см. [Целевые события](celevye-sobytiya.md)), по отношению к которому будет рассчитываться конверсия.
...
<figure><img src="../../.gitbook/assets/мои сайты (2).webp" alt=""><figcaption><p>Пример раздела «Мои сайты»</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/2 (7).png" alt=""><figcaption><p>Пример заведения конверсии</p></figcaption></figure>
...
Выберите необходимые цели, которые вы заранее создали в отчёте «[Целевые события](celevye-sobytiya.md)».
